...
const NewVersion = ({ info }) => {
    return (
        <div className="p-40 overflow-hide">
            ...
            <div className="new-version-info">
                <h3>New Version Available</h3>
                <h3>Version: {info.version}</h3>
                <a href={info.url} target="_blank" className="install-btn">Install Now:</a>
                <a href={info.url} target="_blank" className="target-link">{info.url}</a>
                <h3>Features</h3>
                <ul>

...
import { UserAnswer, FeedbackState, Kind } from "./types"
import { WorldviousFeedbackQuestion, WorldviousFeedbackRequest } from '@kubevious/ui-middleware/dist/services/worldvious'
...
export const Feedback : FC<FeedbackProps> = ({ item }) => {
    ...
    const updateAnswer = (qustion: WorldviousFeedbackQuestion, answer: UserAnswer) => {
                    ...
                    item.questions.map((question, index) => (
                        <div className="feedback-question" key={index}>
                            <Question question={question}
                                      ...
                                      updateAnswer={(answer) => updateAnswer(question, answer)} />
                        </div>
                    ))}
